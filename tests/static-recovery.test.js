...
assert.match(html, /assets\/dist\/css\/styles-v2\.min\.css\?v=20260721-worker-onboarding-1/);
assert.match(html, /assets\/dist\/css\/20-component-table\.min\.css\?v=20260721-worker-onboarding-1/);
assert.match(html, /assets\/dist\/css\/30-feature-signature\.min\.css\?v=20260721-worker-onboarding-1/);
assert.match(html, /assets\/dist\/css\/30-feature-push-management\.min\.css\?v=20260721-worker-onboarding-1/);
assert.match(html, /assets\/dist\/css\/30-feature-monthly-worker\.min\.css\?v=20260721-worker-onboarding-1/);
assert.match(html, /assets\/dist\/css\/20-component-disabled-reason\.min\.css\?v=20260721-worker-onboarding-1/);
assert.match(html, /assets\/js\/vendor\/supabase-js-2\.105\.3\.min\.js/);
assert.match(html, /assets\/dist\/js\/xlsx-helpers\.min\.js\?v=20260721-worker-onboarding-1/);
assert.match(html, /assets\/dist\/js\/analytics-model\.min\.js\?v=20260721-worker-onboarding-1/);
assert.match(html, /assets\/dist\/js\/ship-import-rules\.min\.js\?v=20260721-worker-onboarding-1/);
assert.match(html, /assets\/dist\/js\/push-rules\.min\.js\?v=20260721-worker-onboarding-1/);
assert.match(html, /assets\/dist\/js\/app-v2\.min\.js\?v=20260721-worker-onboarding-1/);
...
[
  ...
  assert.match(page, /assets\/dist\/css\/styles-v2\.min\.css\?v=20260721-worker-onboarding-1/, `${file} should use v2 styles with cache busting`);
  assert.match(page, /assets\/dist\/css\/20-component-table\.min\.css\?v=20260721-worker-onboarding-1/, `${file} should use table component styles with cache busting`);
  assert.match(page, /assets\/dist\/css\/30-feature-signature\.min\.css\?v=20260721-worker-onboarding-1/, `${file} should use signature feature styles with cache busting`);
  assert.match(page, /assets\/dist\/css\/30-feature-push-management\.min\.css\?v=20260721-worker-onboarding-1/, `${file} should use push management feature styles with cache busting`);
  assert.match(page, /assets\/dist\/css\/30-feature-monthly-worker\.min\.css\?v=20260721-worker-onboarding-1/, `${file} should use monthly worker feature styles with cache busting`);
  assert.match(page, /assets\/dist\/css\/20-component-disabled-reason\.min\.css\?v=20260721-worker-onboarding-1/, `${file} should use disabled-reason component styles with cache busting`);
  assert.match(page, /assets\/js\/vendor\/supabase-js-2\.105\.3\.min\.js/, `${file} should use the local Supabase vendor bundle`);
  assert.match(page, /assets\/dist\/js\/push-rules\.min\.js\?v=20260721-worker-onboarding-1/, `${file} should load push rules before the v2 app runtime`);
  assert.match(page, /assets\/dist\/js\/app-v2\.min\.js\?v=20260721-worker-onboarding-1/, `${file} should use the v2 app runtime with cache busting`);
...
assert.match(notFound, /assets\/dist\/css\/styles-v2\.min\.css\?v=20260721-worker-onboarding-1/);
assert.match(notFound, /assets\/dist\/css\/30-feature-not-found\.min\.css\?v=20260721-worker-onboarding-1/);
assert.doesNotMatch(notFound, /assets\/css\/styles\.css/);
const redesignPreview = read("redesign-v2.html");
assert.match(redesignPreview, /assets\/dist\/css\/20-component-table\.min\.css\?v=20260721-worker-onboarding-1/);
assert.match(redesignPreview, /assets\/dist\/css\/30-feature-signature\.min\.css\?v=20260721-worker-onboarding-1/);
assert.match(redesignPreview, /assets\/dist\/css\/30-feature-push-management\.min\.css\?v=20260721-worker-onboarding-1/);
assert.match(redesignPreview, /assets\/dist\/css\/30-feature-monthly-worker\.min\.css\?v=20260721-worker-onboarding-1/);
assert.match(redesignPreview, /assets\/dist\/css\/20-component-disabled-reason\.min\.css\?v=20260721-worker-onboarding-1/);
...
assert.match(app, /const APP_VERSION = "1\.7-20260721-worker-onboarding"/);
...
const sw = read("sw.js");
assert.match(sw, /const APP_VERSION = "1\.7-20260721-worker-onboarding"/);
assert.match(sw, /const ASSET_TOKEN = "20260721-worker-onboarding-1"/);
