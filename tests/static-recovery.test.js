...
assert.match(html, /assets\/css\/styles-v2\.css\?v=20260527-v0-8-worker-public-1/);
assert.match(html, /assets\/js\/vendor\/supabase-js-2\.105\.3\.min\.js/);
assert.match(html, /assets\/js\/app-v2\.js\?v=20260527-v0-8-worker-public-1/);
...
[
  ...
  assert.match(page, /assets\/css\/styles-v2\.css\?v=20260527-v0-8-worker-public-1/, `${file} should use v2 styles with cache busting`);
  assert.match(page, /assets\/js\/vendor\/supabase-js-2\.105\.3\.min\.js/, `${file} should use the local Supabase vendor bundle`);
  assert.match(page, /assets\/js\/app-v2\.js\?v=20260527-v0-8-worker-public-1/, `${file} should use the v2 app runtime with cache busting`);
...
assert.match(notFound, /assets\/css\/styles-v2\.css\?v=20260527-v0-8-worker-public-1/);
...
const sw = read("sw.js");
assert.match(sw, /const CACHE = "gs-safety-v20-20260527-worker-public"/);
assert.match(sw, /styles-v2\.css\?v=20260527-v0-8-worker-public-1/);
assert.match(sw, /app-v2\.js\?v=20260527-v0-8-worker-public-1/);
