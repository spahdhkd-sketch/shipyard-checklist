...
assert.match(html, /assets\/dist\/css\/styles-v2\.min\.css\?v=20260610-design-unify-1/);
assert.match(html, /assets\/dist\/css\/20-component-table\.min\.css\?v=20260610-design-unify-1/);
assert.match(html, /assets\/dist\/css\/30-feature-signature\.min\.css\?v=20260610-design-unify-1/);
assert.match(html, /assets\/dist\/css\/30-feature-push-management\.min\.css\?v=20260610-design-unify-1/);
...
[
  ...
  assert.match(page, /assets\/dist\/css\/styles-v2\.min\.css\?v=20260610-design-unify-1/, `${file} should use v2 styles with cache busting`);
  assert.match(page, /assets\/dist\/css\/20-component-table\.min\.css\?v=20260610-design-unify-1/, `${file} should use table component styles with cache busting`);
  assert.match(page, /assets\/dist\/css\/30-feature-signature\.min\.css\?v=20260610-design-unify-1/, `${file} should use signature feature styles with cache busting`);
  assert.match(page, /assets\/dist\/css\/30-feature-push-management\.min\.css\?v=20260610-design-unify-1/, `${file} should use push management feature styles with cache busting`);
...
assert.match(notFound, /assets\/dist\/css\/styles-v2\.min\.css\?v=20260610-design-unify-1/);
assert.match(notFound, /assets\/dist\/css\/30-feature-not-found\.min\.css\?v=20260610-design-unify-1/);
assert.doesNotMatch(notFound, /assets\/css\/styles\.css/);
const redesignPreview = read("redesign-v2.html");
assert.match(redesignPreview, /assets\/dist\/css\/20-component-table\.min\.css\?v=20260610-design-unify-1/);
assert.match(redesignPreview, /assets\/dist\/css\/30-feature-signature\.min\.css\?v=20260610-design-unify-1/);
assert.match(redesignPreview, /assets\/dist\/css\/30-feature-push-management\.min\.css\?v=20260610-design-unify-1/);
assert.match(redesignPreview, /assets\/dist\/css\/30-feature-monthly-worker\.min\.css\?v=20260610-design-unify-1/);
assert.match(redesignPreview, /assets\/dist\/css\/20-component-disabled-reason\.min\.css\?v=20260610-design-unify-1/);
