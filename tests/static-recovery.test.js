...
assert.match(app, /const REMOTE_AUTHORITATIVE_KEYS = new Set\(\["categories", "sections", "items", "tools"\]\)/);
...
assert.match(app, /작업자 목록에 없나요\?/);
assert.match(app, /여기/);
assert.match(app, /data-action="toggle-other-workers"/);
assert.match(app, /id="otherWorkerSelect"/);
