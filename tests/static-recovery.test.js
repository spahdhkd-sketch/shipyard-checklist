...
assert.match(html, /assets\/css\/styles-v2\.css\?v=20260606-copy-polish-1/);
assert.match(html, /assets\/css\/20-component-table\.css\?v=20260606-copy-polish-1/);
assert.match(html, /assets\/css\/30-feature-signature\.css\?v=20260606-copy-polish-1/);
assert.match(html, /assets\/css\/30-feature-push-management\.css\?v=20260606-copy-polish-1/);
assert.match(html, /assets\/css\/30-feature-monthly-worker\.css\?v=20260606-copy-polish-1/);
assert.match(html, /assets\/css\/20-component-disabled-reason\.css\?v=20260606-copy-polish-1/);
assert.match(html, /assets\/js\/vendor\/supabase-js-2\.105\.3\.min\.js/);
assert.match(html, /assets\/js\/app-v2\.js\?v=20260606-copy-polish-1/);
...
[
  ...
  assert.match(page, /assets\/css\/styles-v2\.css\?v=20260606-copy-polish-1/, `${file} should use v2 styles with cache busting`);
  assert.match(page, /assets\/css\/20-component-table\.css\?v=20260606-copy-polish-1/, `${file} should use table component styles with cache busting`);
  assert.match(page, /assets\/css\/30-feature-signature\.css\?v=20260606-copy-polish-1/, `${file} should use signature feature styles with cache busting`);
  assert.match(page, /assets\/css\/30-feature-push-management\.css\?v=20260606-copy-polish-1/, `${file} should use push management feature styles with cache busting`);
  assert.match(page, /assets\/css\/30-feature-monthly-worker\.css\?v=20260606-copy-polish-1/, `${file} should use monthly worker feature styles with cache busting`);
  assert.match(page, /assets\/css\/20-component-disabled-reason\.css\?v=20260606-copy-polish-1/, `${file} should use disabled-reason component styles with cache busting`);
  assert.match(page, /assets\/js\/vendor\/supabase-js-2\.105\.3\.min\.js/, `${file} should use the local Supabase vendor bundle`);
  assert.match(page, /assets\/js\/app-v2\.js\?v=20260606-copy-polish-1/, `${file} should use the v2 app runtime with cache busting`);
...
assert.match(notFound, /assets\/css\/styles-v2\.css\?v=20260606-copy-polish-1/);
assert.match(notFound, /assets\/css\/30-feature-not-found\.css\?v=20260606-copy-polish-1/);
assert.doesNotMatch(notFound, /assets\/css\/styles\.css/);
const redesignPreview = read("redesign-v2.html");
assert.match(redesignPreview, /assets\/css\/20-component-table\.css\?v=20260606-copy-polish-1/);
assert.match(redesignPreview, /assets\/css\/30-feature-signature\.css\?v=20260606-copy-polish-1/);
assert.match(redesignPreview, /assets\/css\/30-feature-push-management\.css\?v=20260606-copy-polish-1/);
assert.match(redesignPreview, /assets\/css\/30-feature-monthly-worker\.css\?v=20260606-copy-polish-1/);
assert.match(redesignPreview, /assets\/css\/20-component-disabled-reason\.css\?v=20260606-copy-polish-1/);
...
const sw = read("sw.js");
assert.match(sw, /const APP_VERSION = "1\.1-20260606"/);
assert.match(sw, /const ASSET_TOKEN = "20260606-copy-polish-1"/);
