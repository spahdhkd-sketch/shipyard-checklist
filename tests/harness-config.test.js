...
assert.match(harness, /0\.8-20260527/);
assert.match(harness, /20260527-admin-session-boundary-1/);
assert.match(harness, /gs-safety-20260527-admin-session-boundary-1/);
