...
assert.match(harness, /1\.10-20260721-inspection-submit/);
assert.match(harness, /VERSION_LOADING_COPY/);
assert.doesNotMatch(harness, /version 0\.8/);
assert.match(harness, /20260721-inspection-submit-1/);
assert.match(harness, /gs-safety-20260721-inspection-submit-1/);
