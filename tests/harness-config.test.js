...
assert.match(harness, /1\.12\.4-20260814-editor-safety/);
assert.match(harness, /VERSION_LOADING_COPY/);
assert.doesNotMatch(harness, /version 0\.8/);
assert.match(harness, /20260814-editor-safety-1/);
assert.match(harness, /gs-safety-20260814-editor-safety-1/);
