...
assert.match(harness, /1\.7-20260721-worker-onboarding/);
assert.match(harness, /VERSION_LOADING_COPY/);
assert.doesNotMatch(harness, /version 0\.8/);
assert.match(harness, /20260721-worker-onboarding-1/);
assert.match(harness, /gs-safety-20260721-worker-onboarding-1/);
