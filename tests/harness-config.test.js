...
assert.match(harness, /1\.12\.3-20260810-empty-sections/);
assert.match(harness, /VERSION_LOADING_COPY/);
assert.doesNotMatch(harness, /version 0\.8/);
assert.match(harness, /20260810-empty-sections-1/);
assert.match(harness, /gs-safety-20260810-empty-sections-1/);
