...
assert.match(harness, /1\.1-20260606/);
assert.match(harness, /APP_FALLBACK_VERSION/);
assert.doesNotMatch(harness, /version 0\.8/);
assert.match(harness, /20260606-workprep-manage-history-1/);
assert.match(harness, /gs-safety-20260606-workprep-manage-history-1/);
