...
const ASSET_TOKEN = "20260902-v3-1";
...
const SHELL = [
  ...
  `/assets/dist/css/30-feature-control-center.min.css?v=${ASSET_TOKEN}`,
  "/assets/js/vendor/supabase-js-2.105.3.min.js",
  "/assets/js/vendor/hisafe-ra-widget.js",
  ...
  `/assets/dist/js/control-map-view.min.js?v=${ASSET_TOKEN}`,
