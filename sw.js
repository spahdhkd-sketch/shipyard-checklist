const CACHE = "gs-safety-v18-20260527-unsafe-push-db";
const SHELL = [
  "/",
  "/index.html",
  "/manifest.json",
  ...
  "/assets/css/styles-v2.css?v=20260527-unsafe-push-db-1",
  "/assets/js/vendor/supabase-js-2.105.3.min.js",
  "/assets/js/checklist-rules.js?v=20260527-unsafe-push-db-1",
  "/assets/js/issue-material-rules.js?v=20260527-unsafe-push-db-1",
  "/assets/js/app-v2.js?v=20260527-unsafe-push-db-1"
];
