...
try {
  ...
  for (const page of pages) {
    ...
    add(`${page} uses app-v2`, html.includes("assets/js/app-v2.js?v=20260526-input-preserve-1"));
    add(`${page} uses styles-v2`, html.includes("assets/css/styles-v2.css?v=20260526-input-preserve-1"));
  ...
  assertContains(sw, 'const CACHE = "gs-safety-v15-20260526-input-preserve"', "service worker cache is current");
  assertContains(notFound, "assets/css/styles-v2.css?v=20260526-input-preserve-1", "404 uses v2 styles");
  ...
  if (runLive) {
    try {
      ...
      add("live index uses app-v2", indexLive.text.includes("assets/js/app-v2.js?v=20260526-input-preserve-1"));
      add("live 404 page uses v2 styles", notFoundLive.text.includes("assets/css/styles-v2.css?v=20260526-input-preserve-1"));
